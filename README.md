...
🔬 **Computational Materials Science** | 💹 **Quantitative Finance** | 🤖 **AI-Native Builder**
...
> Building at the intersection of physics simulation, machine learning, and financial engineering. From discovering new ceramics that survive 3000 K to detecting chart patterns with computer vision — if it involves data and hard problems, I'm in.
...
- 📉 **Training custom YOLO models** — Building labeled datasets of chart patterns for higher-accuracy visual detection
...
- Run molecular dynamics simulations and stock screeners on the same GPU
- Believe the best way to learn physics is to simulate it
